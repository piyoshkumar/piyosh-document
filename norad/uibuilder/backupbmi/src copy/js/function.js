...
function storeBmi() {
    ...
    showAlertAndRedirect("success", "Success", "BMI calculated and data saved.", "Reports.html")
...
function storeBp() {
    ...
    showAlertAndRedirect("success", "Success", "BP calculated and data saved.","Reports.html");
...
function storeSpo() {
    ...
    showAlertAndRedirect("success", "Success", "SpO2 calculated and data saved.","Reports.html");
    // alert("BMI calculated and data stored in localStorage.");
}
